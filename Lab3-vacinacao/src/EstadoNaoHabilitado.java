...
public class EstadoNaoHabilitado extends State{

	EstadoNaoHabilitado(Pessoa pessoa) {
		super(pessoa);
	}

	@Override
	public String naoHabilitada() {
		pessoa.setState(new EstadoNaoHabilitado(pessoa));
